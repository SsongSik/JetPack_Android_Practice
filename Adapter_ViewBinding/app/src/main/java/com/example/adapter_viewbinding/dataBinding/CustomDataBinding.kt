...
import com.example.adapter_viewbinding.databinding.TextRowItemBinding

class CustomDataBinding (private val dataSet : ArrayList<String>) : RecyclerView.Adapter<CustomDataBinding.ViewHolder>(){
